...
//
//
// T_exp translateExp(A_exp root)
// {
//     int d=0;
//     A_exp v=root;
//     switch (root->kind) {
//         case A_varExp:
//             fprintf(stdout, "varExp(\n"); pr_var(stdout, v->u.var, d+4);
//             fprintf(stdout, "%s", ")");
//             break;
//         case A_nilExp:
...
//             break;
//         case A_intExp:
//             fprintf(stdout, "intExp(%d)", v->u.intt);
//             break;
//         case A_doubleExp:
//             fprintf(stdout, "doubleExp(%f)", v->u.doublee);
//             break;
//         case A_stringExp:
//             fprintf(stdout, "stringExp(%s)", v->u.stringg);
//             break;
//         case A_callExp:
//             fprintf(stdout, "callExp(%s,\n", S_name(v->u.call.func));
//             pr_expList(stdout, v->u.call.args, d+4); fprintf(stdout, ")");
//             break;
//         case A_opExp:
//             fprintf(stdout, "opExp(\n");
//             indent(stdout, d+4); pr_oper(stdout, v->u.op.oper); fprintf(stdout, ",\n");
//             pr_exp(stdout, v->u.op.left, d+4);
//             fprintf(stdout, ",\n");
//             pr_exp(stdout, v->u.op.right, d+4);
//             fprintf(stdout, ")");
//             break;
//         case A_recordExp:
//             fprintf(stdout, "recordExp(%s,\n", S_name(v->u.record.typ));
//             pr_efieldList(stdout, v->u.record.fields, d+4); fprintf(stdout, ")");
//             break;
//         case A_seqExp:
//             fprintf(stdout, "seqExp(\n");
//             pr_expList(stdout, v->u.seq, d+4);
//             fprintf(stdout, ")");
//             break;
//         case A_assignExp:
//             fprintf(stdout, "assignExp(\n");
//             pr_var(stdout, v->u.assign.var, d+4);
//             fprintf(stdout, ",\n");
//             pr_exp(stdout, v->u.assign.exp, d+4);
//             fprintf(stdout, ")");
//             break;
//         case A_ifExp:
//             fprintf(stdout, "iffExp(\n");
//             pr_exp(stdout, v->u.iff.test, d+4);
//             fprintf(stdout, ",\n");
//             pr_exp(stdout, v->u.iff.then, d+4);
//             if (v->u.iff.elsee) { /* else is optional */
//               fprintf(stdout, ",\n");
//               pr_exp(stdout, v->u.iff.elsee, d+4);
//             }
//             fprintf(stdout, ")");
//             break;
//         case A_whileExp:
//             fprintf(stdout, "whileExp(\n");
//             pr_exp(stdout, v->u.whilee.test, d+4);
//             fprintf(stdout, ",\n");
//             pr_exp(stdout, v->u.whilee.body, d+4);
//             fprintf(stdout, ")\n");
//             break;
//         case A_forExp:
//             fprintf(stdout, "forExp(%s,\n", S_name(v->u.forr.var));
//             pr_exp(stdout, v->u.forr.lo, d+4);
//             fprintf(stdout, ",\n");
//             pr_exp(stdout, v->u.forr.hi, d+4);
//             fprintf(stdout, "%s\n", ",");
//             pr_exp(stdout, v->u.forr.body, d+4);
//             fprintf(stdout, ",\n");
//             indent(stdout, d+4);
//             fprintf(stdout, "%s", v->u.forr.escape ? "TRUE)" : "FALSE)");
//         break;
//             case A_breakExp:
...
//             pr_decList(stdout, v->u.declare_expression.decs, d+4);
//             fprintf(stdout, ",\n");
//             pr_exp(stdout, v->u.declare_expression.body, d+4);
//             fprintf(stdout, ")");
//             break;
//         case A_arrayExp:
//             fprintf(stdout, "arrayExp(%s,\n", S_name(v->u.array.typ));
//             pr_exp(stdout, v->u.array.size, d+4);
//             fprintf(stdout, ",\n");
//             pr_exp(stdout, v->u.array.init, d+4);
//             fprintf(stdout, ")");
//             break;
//         case A_decListExp:
//             pr_decList(stdout, v->u.decList, d+4);
//             break;
//         case A_decExp:
//             pr_dec(stdout, v->u.dec,d+4);
//             break;
//         case A_fieldListExp:
//             pr_fieldList(stdout, v->u.fieldList, d+4);
//             break;
//         case A_fieldExp:
//             pr_field(stdout, v->u.field,d+4);
//             break;
//         case A_functionDecExp:
//             pr_fundec(stdout, v->u.fun, d+4);
//             break;
//         case A_functionDecListExp:
//             pr_fundecList(stdout, v->u.funList,d+4);
//             break;
//         default:
//             assert(0);
//     }
